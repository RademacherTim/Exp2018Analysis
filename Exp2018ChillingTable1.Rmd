---
title: "Experiment 2018 Chilling Table 1"
...
allometricData <- read_csv (file = './data/allometricDataExp2018.csv', col_types = cols ())

# Delete rows with compressed tree
allometricData <- allometricData %>% filter (tree %in% c (1:5,11:15))

# Delete irrelevant columns
allometricData <- allometricData %>% select (-year, -previous.ID, -c50, -d50, -c150, -c250, -d250, -h1, -h2, -h3, -comments)

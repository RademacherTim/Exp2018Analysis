...
kbl (tableData, 
     caption = 'Table S2 - lists mean and standard error of the mean for A LOT OF VARIABLES. The table was automatically generated from publicly available data set (data set ID here) on the Harvard Forest Data Archive.',
     col.names = NULL) %>% 

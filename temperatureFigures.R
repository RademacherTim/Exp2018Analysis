...
plot (x = tempData [['datetime']], 
      ...
      ylim = c (-2, 35),
      xaxt = 'n', xlab = '', ylab = '2.0 m',
      col = tColours [['colour']] [5], axes = FALSE, lty = 1, lwd = 2)

# add axis
#----------------------------------------------------------------------------------------
axis (side = 2, at = seq (0, 30, 10), las = 1)
axis (side = 1, at = seq (as_datetime ('2018-08-24'), as_datetime ('2018-08-27'), 
                          length.out = 4), label = rep ('', 4))
...
# plot temperature of chilled and control trees at 1 and 2m 
#----------------------------------------------------------------------------------------
png (filename = './fig/Exp2018ChillingTemperature.png', width = 700, height = 400)
layout (matrix (1:3), heights = c (1, 1, 1.2))
par (mar = c (1, 5, 1, 1))
plot (x = tempData [['datetime']], 
      y = tempData [['t.01.2p0m']], 
...
#----------------------------------------------------------------------------------------
axis (side = 2, at = seq (0, 30, 10), las = 1)
axis (side = 1, at = seq (as_datetime ('2018-06-01'), as_datetime ('2018-10-01'), 
                          length.out = 5), label = rep ('', 5))
...
#----------------------------------------------------------------------------------------
lines (x = tempData [['datetime']], 
       y = tempData %>% select (t.06.1p5m, t.07.1p5m, t.08.1p5m, t.10.1p5m) %>% rowMeans (na.rm = TRUE),
...
#----------------------------------------------------------------------------------------
axis (side = 1, at = seq (as_datetime ('2018-06-01'), as_datetime ('2018-10-01'), 
                          length.out = 5), label = c ('June','July','August',
                                                      'September','October'))
axis (side = 2, at = seq (0, 30, 10), las = 1)

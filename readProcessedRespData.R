...
# white pines 
#----------------------------------------------------------------------------------------
respDataAll <- read_csv (file = './data/respirationData_HF_Exp2018.csv', # TR change name eventually to Harvard Forest dataset 
                      col_types = cols (
...
# divide data by study (i.e., Exp2018, SoilResp2018, Obs2018, Obs2019)
#----------------------------------------------------------------------------------------
respDataExp2018      <- respDataAll %>% filter (study == 'Exp2018')
respDataSoilResp2018 <- respDataAll %>% filter (study == 'SoilResp2018')

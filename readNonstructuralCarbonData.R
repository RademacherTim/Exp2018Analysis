...
# taking into account different calibration curve for the samples and the LCS Oak and LCS 
# Potato
#----------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------
dataExp2018 <- rbind (processedDataWood2018, select (processedDataWoodLCS2018, -SRFHigh, -LCSOakDeviation))
...
dataExp2018 [['treeID']] [condition] <- as.numeric (substr (dataExp2018 [['SampleID']] [condition], 5, 6))
...
# clean up
#----------------------------------------------------------------------------------------
rm (i, temp, COV, originalDir, temp1, temp2, packageDir, res)
